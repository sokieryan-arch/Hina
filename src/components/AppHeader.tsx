...
export function AppHeader({
  ...
  return (
    <header className="flex-none border-b border-[#E8E2D6] dark:border-[#3a2347] px-4 py-3 sm:px-8 flex items-center justify-between bg-white/70 dark:bg-[#1c1224]/85 backdrop-blur-sm z-20 sticky top-0 shadow-[0_1px_2px_-1px_rgba(0,0,0,0.05)] dark:shadow-none transition-colors duration-300">
      {view === "chat" ? (
        <button
          type="button"
          onClick={onOpenSpace}
